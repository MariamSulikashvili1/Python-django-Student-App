from student_app.contrib import admin
from student_app.urls import path,include
from . import views
from student_app.contrib.auth import views as auth_views
from student_app.views.generic.base import RedirectView

from student_app.conf import settings
from student_app.conf.urls.static import static
