import datetime
from student_app.shortcuts import redirect, render
import json
from student_app.contrib import messages
from student_app.contrib.auth.models import User
from student_app.http import HttpResponse
from student_app. import models, forms
from student_app.db.models import Q
from student_app.contrib.auth import authenticate, login, logout, update_session_auth_hash
from student_app .contrib.auth.decorators import login_required
